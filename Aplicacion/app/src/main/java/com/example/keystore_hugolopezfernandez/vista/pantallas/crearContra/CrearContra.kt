...
@Composable
fun CrearContra(navController: NavController, id: String, uid: String, viewModel: CrearContraVM) {
            ...
            Box(
                ...
                LazyColumn(
                    ...
                    content = {
                        ...
                        item{
                            BotonTonalKeyStore(
                                alClickar = { viewModel.GenerarPasswordRandom(contenidoItem1)  },
                                modifier = Modifier.fillMaxWidth(),
                                valorTexto = "CONTRA ALEATORIA"
                            )
                        }
                        item {
                            InputDelineadoKeystore(
                            ...
                            BotonTonalKeyStore(
                                alClickar = {
                                    val listaItems = listOf(
                                        ItemsDatos("Correo", contenidoItem1, false),
                                        ItemsDatos("Contraseña", contenidoItem2, false),
                                        ItemsDatos("Página WEB", contenidoItem3, true)
                                    )
